...
def show_workers_window():
    ...
    def on_map_click(event):
        ...
        marker = map_workers.set_marker(lat, lon, text="Nowy", icon=worker_pin_image)
    ...
    def on_worker_select(event):
        ...
        if worker.coordinates:
            ...
            if selected_marker[0]:
                selected_marker[0].delete()
            marker = map_workers.set_marker(worker.coordinates[0], worker.coordinates[1], icon=worker_pin_image)
            selected_marker[0] = marker
...
def show_suppliers_window():
    ...
    def on_map_click_s(event):
        ...
        marker = map_suppliers.set_marker(lat, lon, text="Nowy", icon=delivery_pin_image)
    ...
    def on_supplier_select(event):
        ...
        if supplier.coordinates:
            ...
            if selected_marker_s[0]:
                selected_marker_s[0].delete()
            marker = map_suppliers.set_marker(supplier.coordinates[0], supplier.coordinates[1], icon=delivery_pin_image)
            selected_marker_s[0] = marker
